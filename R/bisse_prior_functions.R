...
#   }
#   if(3 %in% idparsopt){
#     dens_lam3 <- stats::dexp(pars[3],2)
#   } else {
#     dens_lam3 <- 1
#   }
#   if(4 %in% idparsopt){
#     dens_mu1 <- stats::dexp(pars[4],2)
#   } else {
#     dens_mu1 <- 1
#   }
#   if(5 %in% idparsopt){
#     dens_mu2 <- stats::dexp(pars[5],2)
#   } else {
#     dens_mu2 <- 1
#   }
#   if(6 %in% idparsopt){
#     dens_mu3 <- stats::dexp(pars[6],2)
#   } else {
#     dens_mu3 <- 1
#   }
#   if(7 %in% idparsopt){
#     dens_q12 <- stats::dexp(pars[7],2)
#   } else {
#     dens_q12 <- 1
#   }
#   if(8 %in% idparsopt){
#     dens_q13 <- stats::dexp(pars[8],2)
#   } else {
#     dens_q13 <- 1
#   }
#   if(9 %in% idparsopt){
#     dens_q21 <- stats::dexp(pars[9],2)
#   } else {
#     dens_q21 <- 1
#   }
#   if(10 %in% idparsopt){
#     dens_q23 <- stats::dexp(pars[10],2)
#   } else {
#     dens_q23 <- 1
#   }
#   if(11 %in% idparsopt){
#     dens_q31 <- stats::dexp(pars[11],2)
#   } else {
#     dens_q31 <- 1
#   }
#   if(12 %in% idparsopt){
#     dens_q32 <- stats::dexp(pars[12],2)
#   } else {
#     dens_q32 <- 1
#   }
#   return(dens_lam1 * dens_lam2 * dens_lam3 *
...
prior_dens_geosse <- function(pars,idparsopt) {
  ...
  if(6 %in% idparsopt){
    dens_q12 <- stats::dexp(pars[6],2)
  } else {
    dens_q12 <- 1
  }
  if(7 %in% idparsopt){
    dens_q21 <- stats::dexp(pars[7],2)
  } else {
    dens_q21 <- 1
  }
  return(dens_lam1 * dens_lam2 * dens_lam3 *
...
prior_gen_geosse <- function(pars,idparsopt){
  ...
  return(as.numeric(c(lam1,lam2,lam3,mu1,mu2,q12,q21)))
}