...
calc_error_pairwise <- function(sim_1,
  ...
  # pairwise
  pairwise_error <- pairwise_error(sim_1,sim_2)
  pw_nltt <- pairwise_error$pw_nltt
  pw_clade_size <- pairwise_error$pw_clade_size
  pw_colon_time <- pairwise_error$pw_colon_time
...
#' @author Shu Xie
#' @export
pairwise_error <- function(sim1,sim2){
