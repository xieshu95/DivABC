...
library(ggplot2)
# formate results
load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/obs_ss_long_with_pars_DI.RData"))
## ABC results
folder_path <- paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/DAISIE_ABC_DI")
...
for(n in c(0)){ # 1,2,6,7,20
  ...
  save(whole_df_ABC,
       file = paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/whole_df_ABC_ss_set",n,".RData"))
  ...
  save(whole_df_ABC,file =
         paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/delta_whole_df_ABC_ss_set",n,".RData"))

}

######
# 2. formate MCMC results (only plot the etimation points with ABC results)
folder_path <- "D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/DAISIE_MCMC_DI"
files <- list.files(folder_path)
param_data <- readr::read_csv2("data/DAISIE_ABC_DI.csv")
param_data <- param_data[1:81,]
param_data3<-param_data[rep(seq_len(nrow(param_data)), each=2001),] #2001
...
for(i in 1:81){
  file_to_load <- grep(paste0("DAISIE_MCMC_DI_param_set_", i,"_ss_1.RData"), #"_rep",rep,
                       files,
                       value = TRUE,
                       fixed = TRUE)
  ...
  if (!identical(file_to_load, character())) {
    ...
    lac_mcmc <- c(lac_mcmc, rep(NA,2001))
    mu_mcmc <- c(mu_mcmc, rep(NA,2001))
    gam_mcmc <- c(gam_mcmc, rep(NA,2001))
    laa_mcmc <- c(laa_mcmc, rep(NA,2001))
  }
}
...
save(whole_df_MCMC,file = paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/whole_df_MCMC.RData"))
...
save(whole_df_MCMC,
     file = paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/delta_whole_df_MCMC.RData"))

######
# MLE
load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/whole_df_MLE_DI.RData"))

# # MLE_DI directly load MLE results from cluster
# param_data <- readr::read_csv2("data/DAISIE_ABC_DI.csv")
# load("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/MLE_DI.RData")
...
# save(whole_df_MLE,file = "D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/whole_df_MLE_DI.RData")

#####
# plot MCMC trace
folder_path <- "D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/DAISIE_MCMC_DD"
files <- list.files(folder_path)
for(i in 1:81){
  ...
  if (!identical(file_to_load, character())) {
    load(file.path(folder_path, file_to_load))
    tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/MCMC_trace_DD/set_",i,".tiff"),
...
for(ss in c(0,1,2,6,7,20)){
  load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/delta_whole_df_ABC_ss_set",ss,".RData"))
  load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/delta_whole_df_MCMC.RData"))
  load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/whole_df_MLE.RData"))
  load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/obs_ss_long_with_pars.RData"))
  ...
  save(AMM_all_df,file = paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/AMM_per_set_ss",ss,".RData"))
  ...
  save(AMM_all_df,file = paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/AMM_per_set_drate_ss",ss,".RData"))
}
...
for(ss in c(0,1,2,6,7,20)){
  load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/AMM_per_set_ss",ss,".RData"))
  ...
  tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/exact_rate_ss",ss,".tiff"),
...
for(ss in c(0,1,2,6,7,20)){  #0,1,2,6,7,20
  load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/AMM_per_set_drate_ss",ss,".RData"))
  color_values <-c("ABC" = "red3","MCMC" = "green2", "MLE" = "yellow2")
  p_lac <-ggplot2::ggplot(data = AMM_all_df) +
    ggplot2::theme_bw() +
  ...
  tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/drate_ss",ss,".tiff"),
...
for(ss in c(0)){ #c(0,1,2,6,7,20)
  ...
  for(i in 1:10){
    ...
    param_mcmc <- whole_df_MCMC[((i*2001-499)):(i*2001),]
    ...
    tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/cowplot_AMM/ss_",ss,"AMM_hist_set_",i,".tiff"),
...
folder_path <- "D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/DAISIE_ABC_DD"
files <- list.files(folder_path)
for(n in c(0,1,2,56,7,20)){
  for(set in 1:81){
    ...
    if (!identical(file_to_load, character())) {
      ...
      tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/dss/ss_",n,"_param_",set,".tiff"),
...
for(n in c(0,1,2,6,7,20)){
  for(set in 1:81){
    ...
    if (!identical(file_to_load, character())) {
      ...
      tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/rate_each_gene/ss_",n,"_param_",set,".tiff"),
...
load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/whole_df_MLE.RData"))
for(n in c(0)){
  load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/delta_whole_df_ABC_ss_set",n,".RData"))
  for(i in 1:81){
    param_abc <- whole_df_ABC[((i*500-499)):(i*500),]
    ...
    if(!is.na(param_abc[1,6])){
      ...
      tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/cowplots_hist/ss",n,"_param_",i,".tiff"),
...
whole_df_ABC$ss = "ABC"
whole_df_ABC = whole_df_ABC[,-6]
whole_df_ABC$total <- rep(rep(pars_ss$total, each = 300), 1)
...
whole_df_MCMC$total <- rep(rep(pars_ss$total, each = 2001), 1)
...
load("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/whole_df_MLE_DI.RData")
whole_df_MLE$ss = "MLE"
...
save(whole_df_all, file = paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/whole_df_all_81_AMM.RData"))
...
p_netdiv_lac <-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = total,y = dnet_div,color = ss)) +
  ...
  ggplot2::scale_colour_manual(values = c("red4","#8CC269","#4393C3"))+
  ggplot2::theme(title = ggplot2::element_text(size = 12),
                 text = ggplot2::element_text(size = 12)) +
  ggplot2::xlab("Tree size") +
  ggplot2::ylab(expression(Delta~Net~diversification))+
...
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/drate_ABC_netdiv_lac.tiff"),
...
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/drate_ABC_netdiv_mu.tiff"),
     units="px", width=5000, height=3000,res = 300,compression="lzw")
print(p_netdiv_mu)
while (!is.null(dev.list()))  dev.off()
...
p_netdiv_gam <-ggplot2::ggplot(data = whole_df_ABC,mapping = aes(x = total,y = dnet_div,color = ss)) +
  ...
  ggplot2::geom_hline(yintercept = 0, linetype = "dashed", size = 0.5)+
  facet_wrap(~ gam)
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/drate_ABC_netdiv_gam.tiff"),
     units="px", width=5000, height=3000,res = 300,compression="lzw")
print(p_netdiv_gam)
while (!is.null(dev.list()))  dev.off()
...
p_netdiv_laa <-ggplot2::ggplot(data = whole_df_ABC,mapping = aes(x = total,y = dnet_div,color = ss)) +
  ...
  ggplot2::geom_hline(yintercept = 0, linetype = "dashed", size = 0.5)+
  facet_wrap(~ laa)
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/drate_ABC_netdiv_laa.tiff"),
     units="px", width=5000, height=3000,res = 300,compression="lzw")
print(p_netdiv_laa)
while (!is.null(dev.list()))  dev.off()
...
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/drate_81.tiff"),
     units="px", width=5000, height=3000,res = 300,compression="lzw")
print(p_netdiv_all)
while (!is.null(dev.list()))  dev.off()
...
p_lac<-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = dlac,y = ss,color = ss)) +
  ...
  facet_grid(lac+mu~ gam+laa,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                 ...
                                                 gam = as_labeller(gam_names, label_parsed),
                                                 laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/drate_81_lac.tiff"),
     units="px", width=5000, height=3000,res = 300,compression="lzw")
print(p_lac)
while (!is.null(dev.list()))  dev.off()
...
p_mu<-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = dmu,y = ss,color = ss)) +
  ...
  facet_grid(lac+mu~ gam+laa,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                 ...
                                                 gam = as_labeller(gam_names, label_parsed),
                                                 laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/drate_81_mu.tiff"),
     units="px", width=5000, height=3000,res = 300,compression="lzw")
print(p_mu)
while (!is.null(dev.list()))  dev.off()
...
p_gam<-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = dgam,y = ss,color = ss)) +
  ...
  facet_grid(lac+mu~ gam+laa,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                 ...
                                                 gam = as_labeller(gam_names, label_parsed),
                                                 laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/drate_81_gam.tiff"),
     units="px", width=5000, height=3000,res = 300,compression="lzw")
print(p_gam)
while (!is.null(dev.list()))  dev.off()
...
p_laa<-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = dlaa,y = ss,color = ss)) +
  ...
  facet_grid(lac+mu~ gam+laa,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                 ...
                                                 gam = as_labeller(gam_names, label_parsed),
                                                 laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/drate_81_laa.tiff"),
     units="px", width=5000, height=3000,res = 300,compression="lzw")
print(p_laa)
while (!is.null(dev.list()))  dev.off()


p_extfrac_all <-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = dext_frac,y = ss,color = ss)) +
  ggplot2::stat_summary(fun.data = iqr,alpha = 0.6) +
  ggplot2::theme_bw() +
  ggplot2::theme_classic() +
  # ggplot2::xlim(-0.6,0.6)+
...
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie_DI_nltt/drate_81_ext_frac.tiff"),
     units="px", width=5000, height=3000,res = 300,compression="lzw")
print(p_extfrac_all)
while (!is.null(dev.list()))  dev.off()
