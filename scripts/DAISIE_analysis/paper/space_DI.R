## analyse DAISIE results (DI version comparison) for 'daisie_new_space'
#####
library(ggplot2)
# formate results
load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/obs_ss_long_with_pars_DI.RData"))
## ABC results
folder_path <- paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/DAISIE_ABC_short_DI")
...
for(n in c(0,1,2,3)){ # 1,2,6,7,20
  ...
  save(whole_df_ABC,
       file = paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/whole_df_ABC_ss_set",n,".RData"))
  ...
  save(whole_df_ABC,file =
         paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/delta_whole_df_ABC_ss_set",n,".RData"))

}

# 2. formate MCMC results (only plot the etimation points with ABC results)
# skip
folder_path <- "D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/DAISIE_MCMC_short_DI"
files <- list.files(folder_path)
...
save(whole_df_MCMC,file = paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/whole_df_MCMC.RData"))
...
save(whole_df_MCMC,
     file = paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/delta_whole_df_MCMC.RData"))
#

# ######
# 3. MLE
# load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/whole_df_MLE.RData"))

# MLE_DI directly load MLE results from cluster
param_data <- readr::read_csv2("data/DAISIE_ABC_short_DI.csv")
load("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/MLE_DI.RData")
...
save(whole_df_MLE,file = "D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/whole_df_MLE_DI.RData")
...
for(i in 1:160){
  ...
  if (!identical(file_to_load, character())) {
    load(file.path(folder_path, file_to_load))
    tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/MCMC_trace_short/set_",i,".tiff"),
...
library(ggplot2)
load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/obs_ss_long_with_pars.RData"))
...
load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/delta_whole_df_ABC_ss_set",1,".RData"))
whole_df_ABC$ss = "ABC Phylogenetic"
whole_df_ABC_s1 = whole_df_ABC
whole_df_ABC_s1$total <- rep(rep(pars_ss$total, each = 400), 1)
whole_df_ABC_s1$rep <- rep(rep(1:10, each = 400), 16)
whole_df_ABC_s1$num_clade <- rep(rep(pars_ss$num.clade, each = 400), 1)
whole_df_ABC_s1$largest_clade <- rep(rep(pars_ss$largest.clade, each = 400), 1)

load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/delta_whole_df_ABC_ss_set",2,".RData"))
whole_df_ABC$ss = "ABC Diversity"
whole_df_ABC_s2 = whole_df_ABC
whole_df_ABC_s2$total <- rep(rep(pars_ss$total, each = 400), 1)
whole_df_ABC_s2$rep <- rep(rep(1:10, each = 400), 16)
whole_df_ABC_s2$num_clade <- rep(rep(pars_ss$num.clade, each = 400), 1)
whole_df_ABC_s2$largest_clade <- rep(rep(pars_ss$largest.clade, each = 400), 1)
...
load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/delta_whole_df_MCMC.RData"))
whole_df_MCMC$ss = "MCMC"
whole_df_MCMC$total <- rep(rep(pars_ss$total, each = 1000), 1)
whole_df_MCMC$rep <- rep(rep(1:10, each = 1000), 16)
whole_df_MCMC$num_clade <- rep(rep(pars_ss$num.clade, each = 1000), 1)
whole_df_MCMC$largest_clade <- rep(rep(pars_ss$largest.clade, each = 1000), 1)
...
load("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/whole_df_MLE_DI.RData")
whole_df_MLE$ss = "MLE"
...
# tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_ABC_netdiv_lac.tiff"),
...
#              ))))
# tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_ABC_netdiv_mu.tiff"),
#      units="px", width=4000, height=2500,res = 300,compression="lzw")
# print(p_netdiv_mu)
# while (!is.null(dev.list()))  dev.off()
#
...
#   ggplot2::geom_hline(yintercept = 0, linetype = "dashed", size = 0.5)+
#   facet_wrap(~ gam)
# tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_ABC_netdiv_gam.tiff"),
#      units="px", width=4000, height=2500,res = 300,compression="lzw")
# print(p_netdiv_gam)
# while (!is.null(dev.list()))  dev.off()
#
...
#   ggplot2::geom_hline(yintercept = 0, linetype = "dashed", size = 0.5)+
#   facet_wrap(~ laa)
# tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_ABC_netdiv_laa.tiff"),
#      units="px", width=4000, height=2500,res = 300,compression="lzw")
# print(p_netdiv_laa)
# while (!is.null(dev.list()))  dev.off()
...
p_netdiv_all <-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = dnet_div,y = ss,color = ss)) +
  ...
  # ggplot2::stat_smooth(method = "lm", se = T,alpha = 0.1)+
  ggplot2::scale_colour_manual("Method",values = c("brown4","orange","#FADC8D","#8CC269","#4393C3"))+
  ggplot2::theme(title = ggplot2::element_text(size = 12),
                 text = ggplot2::element_text(size = 12)) +
...
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/paper/drate_net_div_all.tiff"),
     units="px", width=4000, height=2500,res = 300,compression="lzw")
print(p_netdiv_all)
while (!is.null(dev.list()))  dev.off()
...
p_lac<-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = dlac,y = ss,color = ss)) +
  ...
  facet_grid(lac+mu~ gam+laa,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                 ...
                                                 gam = as_labeller(gam_names, label_parsed),
                                                 laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/paper/drate_lac.tiff"),
     units="px", width=4000, height=2500,res = 300,compression="lzw")
print(p_lac)
while (!is.null(dev.list()))  dev.off()
...
p_mu<-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = dmu,y = ss,color = ss)) +
  ...
  facet_grid(lac+mu~ gam+laa,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                 ...
                                                 gam = as_labeller(gam_names, label_parsed),
                                                 laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/paper/drate_mu.tiff"),
     units="px", width=4000, height=2500,res = 300,compression="lzw")
print(p_mu)
while (!is.null(dev.list()))  dev.off()
...
p_gam<-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = dgam,y = ss,color = ss)) +
  ...
  facet_grid(lac+mu~ gam+laa,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                 ...
                                                 gam = as_labeller(gam_names, label_parsed),
                                                 laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/paper/drate_gam.tiff"),
     units="px", width=4000, height=2500,res = 300,compression="lzw")
print(p_gam)
while (!is.null(dev.list()))  dev.off()
...
p_laa<-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = dlaa,y = ss,color = ss)) +
  ...
  facet_grid(lac+mu~ gam+laa,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                 ...
                                                 gam = as_labeller(gam_names, label_parsed),
                                                 laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/paper/drate_laa.tiff"),
     units="px", width=4000, height=2500,res = 300,compression="lzw")
print(p_laa)
while (!is.null(dev.list()))  dev.off()
...
p_netdiv_all <-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = dnet_div,y = ss,color = ss)) +
  ...
  facet_grid(rep~ laa+gam+mu+lac,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                     ...
                                                     gam = as_labeller(gam_names, label_parsed),
                                                     laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/paper/drate_net_div_each_rep.tiff"),
...
p_lac<-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = dlac,y = ss,color = ss)) +
  ...
  facet_grid(rep~ laa+gam+mu+lac,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                     ...
                                                     gam = as_labeller(gam_names, label_parsed),
                                                     laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/paper/drate_lac_each_rep.tiff"),
     units="px", width=8000, height=4000,res = 350,compression="lzw")
print(p_lac)
while (!is.null(dev.list()))  dev.off()
...
p_mu<-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = dmu,y = ss,color = ss)) +
  ...
  facet_grid(rep~ laa+gam+mu+lac,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                     ...
                                                     gam = as_labeller(gam_names, label_parsed),
                                                     laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/paper/drate_mu_each_rep.tiff"),
     units="px", width=8000, height=4000,res = 350,compression="lzw")
print(p_mu)
while (!is.null(dev.list()))  dev.off()
...
p_gam<-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = dgam,y = ss,color = ss)) +
  ...
  facet_grid(rep~ laa+gam+mu+lac,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                     ...
                                                     gam = as_labeller(gam_names, label_parsed),
                                                     laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/paper/drate_gam_each_rep.tiff"),
     units="px", width=8000, height=4000,res = 350,compression="lzw")
print(p_gam)
while (!is.null(dev.list()))  dev.off()
...
p_laa<-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = dlaa,y = ss,color = ss)) +
  ...
  facet_grid(rep~ laa+gam+mu+lac,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                     ...
                                                     gam = as_labeller(gam_names, label_parsed),
                                                     laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/paper/drate_laa_each_rep.tiff"),
     units="px", width=8000, height=4000,res = 350,compression="lzw")
print(p_laa)
while (!is.null(dev.list()))  dev.off()
...
#
# ss = 0
# load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/delta_whole_df_ABC_ss_set",ss,".RData"))
# whole_df_ABC$ss = 0
...
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_netdiv_median.tiff"),
...
p_lac <-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = total,y = dlac, color = ss)) + ##,color = as.factor(gam)
  ...
  ggplot2::geom_hline(yintercept = 0, linetype = "dashed", size = 0.5)
# tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_lac.tiff"),
...
p_mu <-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = total,y = dmu, color = ss)) +
  ...
  ggplot2::geom_hline(yintercept = 0, linetype = "dashed", size = 0.5)
# tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_mu.tiff"),
#      units="px", width=2500, height=1500,res = 350,compression="lzw")
# print(p_mu)
# while (!is.null(dev.list()))  dev.off()
...
p_gam <-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = total,y = dgam, color = ss)) +
  ...
  ggplot2::geom_hline(yintercept = 0, linetype = "dashed", size = 0.5)
# tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_gam.tiff"),
#      units="px", width=2500, height=1500,res = 350,compression="lzw")
# print(p_gam)
# while (!is.null(dev.list()))  dev.off()
...
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_all_rates_median.tiff"),
...
# tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_laa.tiff"),
#      units="px", width=2500, height=1500,res = 350,compression="lzw")
# print(p_laa)
# while (!is.null(dev.list()))  dev.off()
...
p_netdiv <-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = log10(total),y = dnet_div,color = ss)) +
  ...
  facet_grid(mu+gam+laa~lac ,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                 ...
                                                 gam = as_labeller(gam_names, label_parsed),
                                                 laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_net_div_facet.tiff"),
...
p_lac <-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = log10(total),y = dlac, color = ss)) + ##,color = as.factor(gam)
  ...
  facet_grid(mu+gam+laa~lac ,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                 ...
                                                 gam = as_labeller(gam_names, label_parsed),
                                                 laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_lac_facet.tiff"),
     units="px", width=3500, height=2500,res = 300,compression="lzw")
print(p_lac)
while (!is.null(dev.list()))  dev.off()
...
p_mu <-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = log10(total),y = dmu, color = ss)) +
  ...
  facet_grid(mu+gam+laa~lac ,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                 ...
                                                 gam = as_labeller(gam_names, label_parsed),
                                                 laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_mu_facet.tiff"),
     units="px", width=3500, height=2500,res = 300,compression="lzw")
print(p_mu)
while (!is.null(dev.list()))  dev.off()
...
p_gam <-ggplot2::ggplot(data = whole_df_all,mapping = aes(x = log10(total),y = dgam, color = ss)) +
  ...
  facet_grid(mu+gam+laa~lac ,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                 ...
                                                 gam = as_labeller(gam_names, label_parsed),
                                                 laa = as_labeller(laa_names, label_parsed)))
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_gam_facet.tiff"),
     units="px", width=3500, height=2500,res = 300,compression="lzw")
print(p_gam)
while (!is.null(dev.list()))  dev.off()
...
tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_laa_facet.tiff"),
     units="px", width=3500, height=2500,res = 300,compression="lzw")
print(p_laa)
while (!is.null(dev.list()))  dev.off()
...
#   ggplot2::geom_hline(yintercept = 0, linetype = "dashed", size = 0.5)+
#   facet_wrap(~ ss)
# tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_all_particles_fit_lac.tiff"),
#      units="px", width=4000, height=2500,res = 300,compression="lzw")
# print(p_lac)
# while (!is.null(dev.list()))  dev.off()
#
...
#   ggplot2::geom_hline(yintercept = 0, linetype = "dashed", size = 0.5)+
#   facet_wrap(~ ss)
# tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_all_particles_fit_mu.tiff"),
#      units="px", width=4000, height=2500,res = 300,compression="lzw")
# print(p_mu)
# while (!is.null(dev.list()))  dev.off()
#
...
#   ggplot2::geom_hline(yintercept = 0, linetype = "dashed", size = 0.5)+
#   facet_wrap(~ ss)
# tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_all_particles_fit_gam.tiff"),
#      units="px", width=4000, height=2500,res = 300,compression="lzw")
# print(p_gam)
# while (!is.null(dev.list()))  dev.off()
#
...
#   ggplot2::geom_hline(yintercept = 0, linetype = "dashed", size = 0.5)+
#   facet_wrap(~ ss)
# tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_all_particles_fit_laa.tiff"),
#      units="px", width=4000, height=2500,res = 300,compression="lzw")
# print(p_laa)
# while (!is.null(dev.list()))  dev.off()
...
#   ggplot2::geom_hline(yintercept = 0, linetype = "dashed", size = 0.5)+
#   facet_grid(~ lac,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed)))
# tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_nltt_netdiv_lac.tiff"),
#      units="px", width=4500, height=1500,res = 350,compression="lzw")
# print(p_netdiv_lac)
# while (!is.null(dev.list()))  dev.off()
#
...
#   ggplot2::geom_hline(yintercept = 0, linetype = "dashed", size = 0.5)+
#   facet_grid(~ mu,labeller = labeller(mu  = as_labeller(mu_names,  label_parsed)))
# tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_nltt_netdiv_mu.tiff"),
#      units="px", width=4500, height=1500,res = 350,compression="lzw")
# print(p_netdiv_mu)
# while (!is.null(dev.list()))  dev.off()
#
...
#   ggplot2::geom_hline(yintercept = 0, linetype = "dashed", size = 0.5)+
#   facet_grid(~ gam,labeller = labeller(gam  = as_labeller(gam_names,  label_parsed)))
# tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_nltt_netdiv_gam.tiff"),
#      units="px", width=4500, height=1500,res = 350,compression="lzw")
# print(p_netdiv_gam)
# while (!is.null(dev.list()))  dev.off()
#
...
#   ggplot2::geom_hline(yintercept = 0, linetype = "dashed", size = 0.5)+
#   facet_grid(~ laa,labeller = labeller(laa  = as_labeller(laa_names,  label_parsed)))
# tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_nltt_netdiv_laa.tiff"),
#      units="px", width=4500, height=1500,res = 350,compression="lzw")
# print(p_netdiv_laa)
# while (!is.null(dev.list()))  dev.off()
...
for(n in c(0,1,2)){
  ...
  save(ABC_df_all, file = paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/rates_all_generations",n,".RData"))
}

library(ggplot2)
for(ss in c(0,1,2)) {
  load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/rates_all_generations",ss,".RData"))
  iqr = function(z, lower = 0.05, upper = 0.95) {
    data.frame(
      y = median(z),
      ymin = quantile(z, lower),
  ...
  p_netdiv_all <-ggplot2::ggplot(data = ABC_df_all, aes(x = as.factor(generation), y = net_div_ABC)) +
    ...
    facet_grid(rep~laa+gam+mu+lac ,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                       ...
                                                       gam = as_labeller(gam_names, label_parsed),
                                                       laa = as_labeller(laa_names, label_parsed)))
  tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_each_gene_netdiv",ss,".tiff"),
  ...
  p_lac <-ggplot2::ggplot(data = ABC_df_all, aes(x = as.factor(generation), y = lac_abc)) +
    ...
    facet_grid(rep~laa+gam+mu+lac,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                      ...
                                                      gam = as_labeller(gam_names, label_parsed),
                                                      laa = as_labeller(laa_names, label_parsed)))
  tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_each_gene_lac",ss,".tiff"),
       units="px", width=6000, height=3000,res = 350,compression="lzw")
  print(p_lac)
  while (!is.null(dev.list()))  dev.off()
  ...
  p_mu <-ggplot2::ggplot(data = ABC_df_all, aes(x = as.factor(generation), y = mu_abc)) +
    ...
    facet_grid(rep~laa+gam+mu+lac,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                      ...
                                                      gam = as_labeller(gam_names, label_parsed),
                                                      laa = as_labeller(laa_names, label_parsed)))
  tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_each_gene_mu",ss,".tiff"),
       units="px", width=6000, height=3000,res = 350,compression="lzw")
  print(p_mu)
  while (!is.null(dev.list()))  dev.off()
  ...
  p_gam <-ggplot2::ggplot(data = ABC_df_all, aes(x = as.factor(generation), y = gam_abc)) +
    ...
    facet_grid(rep~laa+gam+mu+lac,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                      ...
                                                      gam = as_labeller(gam_names, label_parsed),
                                                      laa = as_labeller(laa_names, label_parsed)))
  tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_each_gene_gam",ss,".tiff"),
       units="px", width=6000, height=3000,res = 350,compression="lzw")
  print(p_gam)
  while (!is.null(dev.list()))  dev.off()
  ...
  p_laa <-ggplot2::ggplot(data = ABC_df_all, aes(x = as.factor(generation), y = laa_abc)) +
    ...
    facet_grid(rep~laa+gam+mu+lac,labeller = labeller(lac  = as_labeller(lac_names,  label_parsed),
                                                      ...
                                                      gam = as_labeller(gam_names, label_parsed),
                                                      laa = as_labeller(laa_names, label_parsed)))
  tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/drate_each_gene_laa",ss,".tiff"),
       units="px", width=6000, height=3000,res = 350,compression="lzw")
  print(p_laa)
  while (!is.null(dev.list()))  dev.off()
...
load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/delta_whole_df_ABC_ss_set",ss,".RData"))
load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/delta_whole_df_MCMC.RData"))
load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/whole_df_MLE_DI.RData"))
## get legend first
...
for(i in 1:160){
  ...
  tiff(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/cowplot_AMM/ss_",ss,"_AMM_hist_set_",i,".tiff"),
...
load(paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/obs_ss_long_with_pars_DI.RData"))
write.csv2(pars_ss,paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/obs_ss_long_with_pars_DI.csv"))


###
load("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/obs_ss_long_with_pars_DI.RData")
df <- pars_ss
n <- 10
...
write.csv2(round(ss_median,0),paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/ss_median.csv"))
write.csv2(round(ss_mean,0),paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/ss_mean.csv"))
write.csv2(round(ss_max,0),paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/ss_max.csv"))
write.csv2(round(ss_min,0),paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/ss_min.csv"))
write.csv2(round(ss_sd,0),paste0("D:/Onedrive-shu/OneDrive/project 2/results/round5/daisie/daisie_new_space/ss_sd.csv"))
