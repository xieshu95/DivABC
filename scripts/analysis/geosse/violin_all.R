...
## lam
i = 1
load(paste0("Data/GeoSSE/whole_df_all_AMM_test",i,".RData"))
...
tiff(paste0("Data/GeoSSE/violin_all_rename.tiff"),
     units="px", width=8000, height=5000,res = 500,compression="lzw")
