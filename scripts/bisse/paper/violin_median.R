...
tiff(paste0("Data/BiSSE/nltts_D/violin_lam_median.tiff"),
...
tiff(paste0("Data/BiSSE/nltts_D/violin_mu_median.tiff"),
     units="px", width=6000, height=8000,res = 500,compression="lzw")
...
tiff(paste0("Data/BiSSE/nltts_D/violin_q_median.tiff"),
     units="px", width=6000, height=8000,res = 500,compression="lzw")
