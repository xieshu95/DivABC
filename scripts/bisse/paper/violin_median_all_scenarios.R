# Violin plot of AMM median combining all scenarios (S1-S7)
# violin median - NLTT+D VS MLE VS MCMC
library(tidyverse)
...
#####
i = 1
load(paste0("Data/BiSSE/nltts_D/median_AMM_test",i,".RData"))
...
tiff(paste0("Data/BiSSE/nltts_D/violin_median_all_7scenarios.tiff"),
     units="in", width=10, height=6,res = 400,compression="lzw")
