...
# tip_ratio_ana1 <- num_ana_sim_1_state1 / num_ana_sim_1_state2
# tip_ratio_ana2 <- num_ana_sim_2_state1 / num_ana_sim_2_state2
# tip_ratio_error_ana <- abs(tip_ratio_ana1 - tip_ratio_ana2)

### 6. number of cladogenetic species
...
num_clado_sim_2_state2 <-
  as.numeric(
    sim_2[[1]][[1]]$stt_two_states[stt_last_row_sim_2, "nC2"])
# tip_ratio_clado1 <- num_clado_sim_1_state1 / num_clado_sim_1_state2
# tip_ratio_clado2 <- num_clado_sim_2_state1 / num_clado_sim_2_state2
# tip_ratio_error_clado <- abs(tip_ratio_clado1 - tip_ratio_clado2)
...
nonendemic_sim_2_state2 <-
  as.numeric(
    sim_2[[1]][[1]]$stt_two_states[stt_last_row_sim_2, "nI2"])
# tip_ratio_nonend1 <- nonendemic_sim_1_state1 / nonendemic_sim_1_state2
# tip_ratio_nonend2 <- nonendemic_sim_2_state1 / nonendemic_sim_2_state2
# tip_ratio_error_nonend <- abs(tip_ratio_nonend1 - tip_ratio_nonend2)
