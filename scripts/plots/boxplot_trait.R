#### boxplot for TraiSIE ABC results
...
# folder_path <- "G:/results/project 2/tip_info/trait_nltt_message/TraiSIE_ABC_DI"


folder_path <- "G:/results/project 2/tip_info/30trait_tip_message/TraiSIE_ABC_DI"
files <- list.files(folder_path)
param_data <- readr::read_csv2("G:/R/Traisie-ABC/data/TraiSIE_ABC_DI.csv")
param_data$Transition <- param_data$trans
param_data$Transition[param_data$trans == "0.001" & param_data$trans2 == "0.001"] <- "t1=t2=0.001"
param_data$Transition[param_data$trans == "0.02" & param_data$trans2 == "0.2"] <- "t1=0.02 t2=0.2"
...
save(whole_df_ABC,file = "G:/results/project 2/tip_info/30trait_tip_message/DI_whole_df_ABC.RData")
load("G:/results/project 2/tip_info/30trait_tip_message/DI_whole_df_ABC.RData")


library(ggplot2)
colors <- c("State1"="red","State2"="blue")
tiff("G:/results/project 2/tip_info/30trait_tip_message/DI_new_boxplot_lac.tiff", units="px", width=800, height=500)
g1 <- ggplot2::ggplot(whole_df_ABC[c(0:50000),], aes(group = lac)) +
  ggplot2::theme_bw() +
  ggplot2::geom_boxplot(aes(x = lac, y = lac_abc1, color = "State1",fill = "State1"),alpha = 0.4)+ ##aes(x = lac, y = lac_abc, color = "ABC")
  ggplot2::geom_boxplot(aes(x = lac2, y = lac_abc2, color = "State2",fill = "State2"),alpha = 0.4)+
  ...
  ggplot2::facet_grid(~Transition)
print(g1)
while (!is.null(dev.list()))  dev.off()


tiff("G:/results/project 2/tip_info/30trait_tip_message/DI_new_boxplot_mu.tiff", units="px", width=800, height=500)
g2 <- ggplot2::ggplot(whole_df_ABC[c(50001:100000),], aes(group = mu)) +
  ggplot2::theme_bw() +
  ggplot2::geom_boxplot(aes(x = mu, y = mu_abc1, color = "State1",fill = "State1"),alpha = 0.5)+ ##aes(x = mu, y = mu_abc, color = "ABC")
  ggplot2::geom_boxplot(aes(x = mu2, y = mu_abc2, color = "State2",fill = "State2"),alpha = 0.5)+
...
tiff("G:/results/project 2/tip_info/30trait_tip_message/DI_new_boxplot_gam.tiff", units="px", width=800, height=500)
g3 <- ggplot2::ggplot(whole_df_ABC[c(100001:150000),], aes(group = gam)) +
  ggplot2::theme_bw() +
  ggplot2::geom_boxplot(aes(x = gam, y = gam_abc1, color = "State1",fill = "State1"),alpha = 0.5)+ ##aes(x = gam, y = gam_abc, color = "ABC")
  ggplot2::geom_boxplot(aes(x = gam2, y = gam_abc2, color = "State2",fill = "State2"),alpha = 0.5)+
...
tiff("G:/results/project 2/tip_info/30trait_tip_message/DI_new_boxplot_laa.tiff", units="px", width=800, height=500)
g4 <- ggplot2::ggplot(whole_df_ABC[c(150001:200000),], aes(group = laa)) +
  ggplot2::theme_bw() +
  ggplot2::geom_boxplot(aes(x = laa, y = laa_abc1, color = "State1",fill = "State1"),alpha = 0.5)+ ##aes(x = laa, y = laa_abc, color = "ABC")
  ggplot2::geom_boxplot(aes(x = laa2, y = laa_abc2, color = "State2",fill = "State2"),alpha = 0.5)+
