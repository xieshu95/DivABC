...
for(test in 1:5){
  # formate results
  load(paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/obs_ss_test",test,".RData"))
  ## ABC results
  folder_path <- paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/secsse_ABC_test",test)
  ...
  save(whole_df_ABC,file = paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/gene3_whole_df_ABC_test",test,".RData"))
  ...
  save(whole_df_ABC,file =
         paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/delta_whole_df_ABC_test",test,".RData"))
...
for(test in 1:5){
  ...
  for(i in 1:100){
    ...
    if (!identical(file_to_load, character())) {
      folder_path_mcmc <- paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/secsse_MCMC_test",test)
  ...
  save(whole_df_MCMC,file = paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/whole_df_MCMC_test",test,"_fit_ABC.RData"))
  ...
  save(whole_df_MCMC,file = paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/delta_whole_df_MCMC_test",test,"_fit_ABC.RData"))
}
...
for(test in 1:5){
  load(paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/whole_df_MLE",test,".RData"))
  ...
  save(whole_df_MLE_fit_ABC,file = paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/whole_df_MLE_test",test,"_fit_ABC.RData"))
}

######
## combine ABC, MCMC, MLE for each parameter set(use median value)
for(test in 1:5){
  load(paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/delta_whole_df_ABC_test",test,".RData"))
  load(paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/delta_whole_df_MCMC_test",test,"_fit_ABC.RData"))
  load(paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/whole_df_MLE_test",test,"_fit_ABC.RData"))
  ...
  save(AMM_all_df,file = paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/AMM_per_set_test",test,".RData"))

  load(paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/AMM_per_set_test",test,".RData"))
  load(paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/obs_ss_test",test,".RData"))
  ...
  save(AMM_all_df,file = paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/AMM_per_set_drate_test",test,"_fit_ABC.RData"))
}

#####
## 4. plot observed treesize /tip ratio vs estimation error
for(test in 1:5){
  load(paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/AMM_per_set_drate_test",test,"_fit_ABC.RData"))
  ...
  tiff(paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/rate_error_test",test,".tiff"),
...
for(test in 1:5){
  ...
  tiff(paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/exact_rate_test",test,".tiff"),
       units="px", width=3000, height=2000,res = 300,compression="lzw")
  param_estimates <- cowplot::plot_grid(
    p_lam1,p_mu1,p_q12,p_lam2,p_mu2,p_q21,
    align = "hv", nrow = 2, ncol = 3
...
for(test in 1:5){
  ...
  tiff(paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/net_div_set_",test,".tiff"),
...
for(test in 1:5){
  ...
  for(i in 1:100){
    ...
    if(!is.na(param_abc[,7])){
      ...
      tiff(paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/cowplot_AMM/test",test,"/AMM_rep_",i,".tiff"),
           units="px", width=3000, height=2000,res = 300,compression="lzw")
      param_estimates <- cowplot::plot_grid(
        p_lam1,p_mu1,p_q12,p_lam2,p_mu2,p_q21,
        align = "hv", nrow = 2, ncol = 3
...
for(test in 1:5){
  ...
  for(i in 1:100){
    ...
    if(!is.na(param_abc[,7])){
      ...
      tiff(paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/net_div/test",test,"/net_div_hist_set_",i,".tiff"),
           units="px", width=2200, height=1000,res = 300,compression="lzw")
      param_estimates <- cowplot::plot_grid(
  ...
  for(set in 1:100){
    ...
    if (!identical(file_to_load, character())) {
      ...
      g10 <- ggplot2::ggplot(ss_dist, aes(x = generation,y = NLTT)) +
        ...
        ggplot2::geom_boxplot()
      # print(g8)
      tiff(paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/dss/test",test,"/param_set",set,".tiff"),
...
for(test in 1:5){
  ...
  for(set in 1:100){
    ...
    if (!identical(file_to_load, character())) {
      ...
      tiff(paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/ABC_rep1/rate_each_gene/test",test,"/param_",set,".tiff"),
           units="px", width=3000, height=2000,res = 300,compression="lzw")
      dss <- cowplot::plot_grid(
        g1,g3,g5,g2,g4,g6,
        align = "hv", nrow = 2, ncol = 3
...
for(test in 1:5){
  load(paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/obs_ss_test",test,".RData"))
  write.csv(pars_ss,paste0("G:/results/project 2/tip_info/round4/adap_secsse_test3_new/obs_ss_test",test,".csv"))
}
