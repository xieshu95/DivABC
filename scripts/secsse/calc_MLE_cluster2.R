library(TraisieABC)
param_space <- readr::read_csv2("/home/p286026/TraisieABC/data/secsse_ABC_test2.csv")
lam1_MLE<- c()
lam2_MLE <-c()
mu1_MLE <- c()
mu2_MLE <-c()
...
save(MLE_all, file = paste0("/home/p286026/results/test2_MLE_secsse",seed_mle,".RData"))
