library(TraisieABC)
param_space <- readr::read_csv2("/home/p290559/TraisieABC/data/secsse_ABC_test4.csv")
lam1_MLE<- c()
lam2_MLE <-c()
mu1_MLE <- c()
mu2_MLE <-c()
...
save(MLE_all, file = paste0("/home/p290559/results/test4_MLE_secsse",seed_mle,".RData"))
