...
for(i in 1:70){
  ...
  file_to_load <- grep(paste0("secsse_ABC_long_param_set_", i,"_ss_1.RData"),  #,"_rep",rep
                       files,
                       value = TRUE,
                       fixed = TRUE)
...
save(whole_df_ABC,file = "G:/results/project 2/tip_info/round4/secsse_long/whole_df_ABC_long.RData")
