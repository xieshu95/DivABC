...
for(num_ss in c(0)){
  for(i in c(1)){
    ...
    p_lam1 <-ggplot2::ggplot(data = AMM) +
      ...
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dlam1_MLE),color = "MLE"),alpha = 0.8) +
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dlam1_mcmc),color = "MCMC"),shape = 17,alpha = 0.8) +
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dlam1_abc),color = "ABC"),shape = 18,alpha = 0.7) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dlam1_MLE),color = "MLE"),method = "lm",se = F) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dlam1_mcmc),color = "MCMC"),method = "lm",se = F) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dlam1_abc),color = "ABC"),method = "lm",se = F) +
      ggplot2::theme_classic() +
      ggplot2::theme(axis.title.x = ggplot2::element_blank(),
                     axis.title.y = ggplot2::element_text(size = 15),
                     text = ggplot2::element_text(size = 15)) +
    ...
    p_lam2 <-ggplot2::ggplot(data = AMM) +
      ggplot2::theme_bw() +
      ggplot2::ylim(-0.6,1.2)+
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dlam2_MLE),color = "MLE"),alpha = 0.8) +
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dlam2_mcmc),color = "MCMC"),shape = 17,alpha = 0.8) +
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dlam2_abc),color = "ABC"),shape = 18,alpha = 0.7) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dlam2_MLE),color = "MLE"),method = "lm",se = F) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dlam2_mcmc),color = "MCMC"),method = "lm",se = F) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dlam2_abc),color = "ABC"),method = "lm",se = F) +
      ggplot2::theme_classic() +
      ggplot2::theme(axis.title.x = ggplot2::element_blank(),
                     axis.title.y = ggplot2::element_text(size = 15),
                     text = ggplot2::element_text(size = 15)) +
    ...
    p_mu1 <-ggplot2::ggplot(data = AMM) +
      ggplot2::theme_bw() +
      ggplot2::ylim(-0.1,1.5)+
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dmu1_MLE),color = "MLE"),alpha = 0.8) +
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dmu1_mcmc),color = "MCMC"),shape = 17,alpha = 0.8) +
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dmu1_abc),color = "ABC"),shape = 18,alpha = 0.7) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dmu1_MLE),color = "MLE"),method = "lm",se = F) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dmu1_mcmc),color = "MCMC"),method = "lm",se = F) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dmu1_abc),color = "ABC"),method = "lm",se = F) +
      ggplot2::theme_classic() +
      ggplot2::theme(axis.title.x = ggplot2::element_blank(),
                     axis.title.y = ggplot2::element_text(size = 15),
                     text = ggplot2::element_text(size = 15)) +
    ...
    p_mu2 <-ggplot2::ggplot(data = AMM) +
      ggplot2::theme_bw() +
      ggplot2::ylim(-0.1,1.5)+
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dmu2_MLE),color = "MLE"),alpha = 0.8) +
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dmu2_mcmc),color = "MCMC"),shape = 17,alpha = 0.8) +
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dmu2_abc),color = "ABC"),shape = 18,alpha = 0.7) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dmu1_MLE),color = "MLE"),method = "lm",se = F) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dmu1_mcmc),color = "MCMC"),method = "lm",se = F) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dmu1_abc),color = "ABC"),method = "lm",se = F) +
      ggplot2::theme_classic() +
    ...
    p_q12 <-ggplot2::ggplot(data = AMM) +
      ggplot2::theme_bw() +
      ggplot2::ylim(-0.1,1.05)+
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dq12_MLE),color = "MLE"),alpha = 0.8) +
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dq12_mcmc),color = "MCMC"),shape = 17,alpha = 0.8) +
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dq12_abc),color = "ABC"),shape = 18,alpha = 0.7) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dq12_MLE),color = "MLE"),method = "lm",se = F) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dq12_mcmc),color = "MCMC"),method = "lm",se = F) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dq12_abc),color = "ABC"),method = "lm",se = F) +
      ggplot2::theme_classic() +
      ggplot2::theme(axis.title.x = ggplot2::element_blank(),
                     axis.title.y = ggplot2::element_text(size = 15),
                     text = ggplot2::element_text(size = 15)) +
    ...
    p_q21 <-ggplot2::ggplot(data = AMM) +
      ggplot2::theme_bw() +
      ggplot2::ylim(-0.1,1.05)+
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dq21_MLE),color = "MLE"),alpha = 0.8) +
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dq21_mcmc),color = "MCMC"),shape = 17,alpha = 0.8) +
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dq21_abc),color = "ABC"),shape = 18,alpha = 0.7) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dq21_MLE),color = "MLE"),method = "lm",se = F) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dq21_mcmc),color = "MCMC"),method = "lm",se = F) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dq21_abc),color = "ABC"),method = "lm",se = F) +
      ggplot2::theme_classic() +
      ggplot2::theme(axis.title.x = ggplot2::element_blank(),
                     axis.title.y = ggplot2::element_text(size = 15),
                     text = ggplot2::element_text(size = 15)) +
    ...
    p_div1 <-ggplot2::ggplot(data = AMM) +
      ggplot2::theme_bw() +
      ggplot2::ylim(-1.5,1)+
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dnet_div_MLE1),color = "MLE"),alpha = 0.8) +
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dnet_div_mcmc1),color = "MCMC"),shape = 17,alpha = 0.8) +
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dnet_div_abc1),color = "ABC"),shape = 18, alpha = 0.7) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dnet_div_MLE1),color = "MLE"),method = "lm",se = F) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dnet_div_mcmc1),color = "MCMC"),method = "lm",se = F) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dnet_div_abc1),color = "ABC"),method = "lm",se = F) +
      ggplot2::theme_classic() +
      ggplot2::theme(axis.title.x = ggplot2::element_blank(),
                     axis.title.y = ggplot2::element_text(size = 11),
                     text = ggplot2::element_text(size = 15)) +
    ...
    p_div2 <-ggplot2::ggplot(data = AMM) +
      ggplot2::theme_bw() +
      ggplot2::ylim(-1.5,1)+
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dnet_div_MLE2),color = "MLE"),alpha = 0.8) +
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dnet_div_mcmc2),color = "MCMC"),shape = 17,alpha = 0.8) +
      ggplot2::geom_point(ggplot2::aes(x = log(ratio),y = (dnet_div_abc2),color = "ABC"),shape = 18,alpha = 0.7) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dnet_div_MLE2),color = "MLE"),method = "lm",se = F) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dnet_div_mcmc2),color = "MCMC"),method = "lm",se = F) +
      # ggplot2::geom_smooth(ggplot2::aes(x = log(ratio),y = (dnet_div_abc2),color = "ABC"),method = "lm",se = F) +
      ggplot2::theme_classic() +
      ggplot2::theme(axis.title.x = ggplot2::element_blank(),
                     axis.title.y = ggplot2::element_text(size = 11),
                     text = ggplot2::element_text(size = 15)) +
