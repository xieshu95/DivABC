...
## lam
i = 1
load(paste0("Data/nltts_D/whole_df_all_AMM_test",i,".RData"))
...
tiff(paste0("Data/nltts_D/violin_lam_all.tiff"),
...
tiff(paste0("Data/nltts_D/violin_mu_all.tiff"),
     units="px", width=6000, height=8000,res = 500,compression="lzw")
...
tiff(paste0("Data/nltts_D/violin_q_all.tiff"),
     units="px", width=6000, height=8000,res = 500,compression="lzw")
